...
pred transition__S02__a__S01__mediante_met_startThermostat{
	(some x,y:EstadoConcreto, v10:Address |
		partitionS02[x] and partitionS01[y] and
		v10 != Address0x0 and met_startThermostat[x, y, v10])
}

pred transition__S02__a__S02__mediante_met_startThermostat{
	(some x,y:EstadoConcreto, v10:Address |
		partitionS02[x] and partitionS02[y] and
		v10 != Address0x0 and met_startThermostat[x, y, v10])
}

run transition__S02__a__S01__mediante_met_startThermostat for 10 EstadoConcreto
run transition__S02__a__S02__mediante_met_startThermostat for 10 EstadoConcreto
pred transition__S02__a__S01__mediante_met_setTargetTemperature{
	(some x,y:EstadoConcreto, v10:Address, v20:Int |
		partitionS02[x] and partitionS01[y] and
		v10 != Address0x0 and met_setTargetTemperature[x, y, v10, v20])
}

pred transition__S02__a__S02__mediante_met_setTargetTemperature{
	(some x,y:EstadoConcreto, v10:Address, v20:Int |
		partitionS02[x] and partitionS02[y] and
		v10 != Address0x0 and met_setTargetTemperature[x, y, v10, v20])
}

run transition__S02__a__S01__mediante_met_setTargetTemperature for 10 EstadoConcreto
run transition__S02__a__S02__mediante_met_setTargetTemperature for 10 EstadoConcreto
pred transition__S02__a__S01__mediante_met_setMode{
	(some x,y:EstadoConcreto, v10:Address, v20:Mode |
		partitionS02[x] and partitionS01[y] and
		v10 != Address0x0 and met_setMode[x, y, v10, v20])
}

pred transition__S02__a__S02__mediante_met_setMode{
	(some x,y:EstadoConcreto, v10:Address, v20:Mode |
		partitionS02[x] and partitionS02[y] and
		v10 != Address0x0 and met_setMode[x, y, v10, v20])
}

run transition__S02__a__S01__mediante_met_setMode for 10 EstadoConcreto
run transition__S02__a__S02__mediante_met_setMode for 10 EstadoConcreto
