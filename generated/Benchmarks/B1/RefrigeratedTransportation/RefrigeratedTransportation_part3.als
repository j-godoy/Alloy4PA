...
pred transition__S04__a__S01__mediante_met_ingestTelemetry{
...
pred transition__S04__a__S02__mediante_met_ingestTelemetry{
	(some x,y:EstadoConcreto, v10:Address, v20:Int, v21:Int, v22:Int |
		partitionS04[x] and partitionS02[y] and
		v10 != Address0x0 and met_ingestTelemetry[x, y, v10, v20, v21, v22])
}

pred transition__S04__a__S03__mediante_met_ingestTelemetry{
	(some x,y:EstadoConcreto, v10:Address, v20:Int, v21:Int, v22:Int |
		partitionS04[x] and partitionS03[y] and
		v10 != Address0x0 and met_ingestTelemetry[x, y, v10, v20, v21, v22])
}

pred transition__S04__a__S04__mediante_met_ingestTelemetry{
	(some x,y:EstadoConcreto, v10:Address, v20:Int, v21:Int, v22:Int |
		partitionS04[x] and partitionS04[y] and
		v10 != Address0x0 and met_ingestTelemetry[x, y, v10, v20, v21, v22])
}

run transition__S04__a__S01__mediante_met_ingestTelemetry for 10 EstadoConcreto
run transition__S04__a__S02__mediante_met_ingestTelemetry for 10 EstadoConcreto
run transition__S04__a__S03__mediante_met_ingestTelemetry for 10 EstadoConcreto
run transition__S04__a__S04__mediante_met_ingestTelemetry for 10 EstadoConcreto
pred transition__S04__a__S01__mediante_met_transferResponsibility{
	(some x,y:EstadoConcreto, v10:Address, v11:Address |
		partitionS04[x] and partitionS01[y] and
		v10 != Address0x0 and met_transferResponsibility[x, y, v10, v11])
}

pred transition__S04__a__S02__mediante_met_transferResponsibility{
	(some x,y:EstadoConcreto, v10:Address, v11:Address |
		partitionS04[x] and partitionS02[y] and
		v10 != Address0x0 and met_transferResponsibility[x, y, v10, v11])
}

pred transition__S04__a__S03__mediante_met_transferResponsibility{
	(some x,y:EstadoConcreto, v10:Address, v11:Address |
		partitionS04[x] and partitionS03[y] and
		v10 != Address0x0 and met_transferResponsibility[x, y, v10, v11])
}

pred transition__S04__a__S04__mediante_met_transferResponsibility{
	(some x,y:EstadoConcreto, v10:Address, v11:Address |
		partitionS04[x] and partitionS04[y] and
		v10 != Address0x0 and met_transferResponsibility[x, y, v10, v11])
}

run transition__S04__a__S01__mediante_met_transferResponsibility for 10 EstadoConcreto
run transition__S04__a__S02__mediante_met_transferResponsibility for 10 EstadoConcreto
run transition__S04__a__S03__mediante_met_transferResponsibility for 10 EstadoConcreto
run transition__S04__a__S04__mediante_met_transferResponsibility for 10 EstadoConcreto
pred transition__S04__a__S01__mediante_met_complete{
	(some x,y:EstadoConcreto, v10:Address |
		partitionS04[x] and partitionS01[y] and
		v10 != Address0x0 and met_complete[x, y, v10])
}

pred transition__S04__a__S02__mediante_met_complete{
	(some x,y:EstadoConcreto, v10:Address |
		partitionS04[x] and partitionS02[y] and
		v10 != Address0x0 and met_complete[x, y, v10])
}

pred transition__S04__a__S03__mediante_met_complete{
	(some x,y:EstadoConcreto, v10:Address |
		partitionS04[x] and partitionS03[y] and
		v10 != Address0x0 and met_complete[x, y, v10])
}

pred transition__S04__a__S04__mediante_met_complete{
	(some x,y:EstadoConcreto, v10:Address |
		partitionS04[x] and partitionS04[y] and
		v10 != Address0x0 and met_complete[x, y, v10])
}

run transition__S04__a__S01__mediante_met_complete for 10 EstadoConcreto
run transition__S04__a__S02__mediante_met_complete for 10 EstadoConcreto
run transition__S04__a__S03__mediante_met_complete for 10 EstadoConcreto
run transition__S04__a__S04__mediante_met_complete for 10 EstadoConcreto
