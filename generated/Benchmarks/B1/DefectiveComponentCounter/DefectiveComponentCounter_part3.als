...
pred transition__S02__a__S01__mediante_met_computeTotal{
	(some x,y:EstadoConcreto, v10:Address |
		partitionS02[x] and partitionS01[y] and
		v10 != Address0x0 and met_computeTotal[x, y, v10])
}

pred transition__S02__a__S02__mediante_met_computeTotal{
	(some x,y:EstadoConcreto, v10:Address |
		partitionS02[x] and partitionS02[y] and
		v10 != Address0x0 and met_computeTotal[x, y, v10])
}

run transition__S02__a__S01__mediante_met_computeTotal for 10 EstadoConcreto, 4 Int
run transition__S02__a__S02__mediante_met_computeTotal for 10 EstadoConcreto, 4 Int
pred transition__S02__a__S01__mediante_met_getDefectiveComponentsCount{
	(some x,y:EstadoConcreto, v10:Address |
		partitionS02[x] and partitionS01[y] and
		v10 != Address0x0 and met_getDefectiveComponentsCount[x, y, v10])
}

pred transition__S02__a__S02__mediante_met_getDefectiveComponentsCount{
	(some x,y:EstadoConcreto, v10:Address |
		partitionS02[x] and partitionS02[y] and
		v10 != Address0x0 and met_getDefectiveComponentsCount[x, y, v10])
}

run transition__S02__a__S01__mediante_met_getDefectiveComponentsCount for 10 EstadoConcreto, 4 Int
run transition__S02__a__S02__mediante_met_getDefectiveComponentsCount for 10 EstadoConcreto, 4 Int
