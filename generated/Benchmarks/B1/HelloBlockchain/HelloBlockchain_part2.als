...
pred transition__S01__a__S01__mediante_met_sendRequest{
...
pred transition__S01__a__S02__mediante_met_sendRequest{
	(some x,y:EstadoConcreto, v10:Address, v20:Message |
		partitionS01[x] and partitionS02[y] and
		v10 != Address0x0 and met_sendRequest[x, y, v10, v20])
}

run transition__S01__a__S01__mediante_met_sendRequest for 10 EstadoConcreto, 4 Message
run transition__S01__a__S02__mediante_met_sendRequest for 10 EstadoConcreto, 4 Message
pred transition__S01__a__S01__mediante_met_sendResponse{
	(some x,y:EstadoConcreto, v10:Address, v20:Message |
		partitionS01[x] and partitionS01[y] and
		v10 != Address0x0 and met_sendResponse[x, y, v10, v20])
}

pred transition__S01__a__S02__mediante_met_sendResponse{
	(some x,y:EstadoConcreto, v10:Address, v20:Message |
		partitionS01[x] and partitionS02[y] and
		v10 != Address0x0 and met_sendResponse[x, y, v10, v20])
}

run transition__S01__a__S01__mediante_met_sendResponse for 10 EstadoConcreto, 4 Message
run transition__S01__a__S02__mediante_met_sendResponse for 10 EstadoConcreto, 4 Message
