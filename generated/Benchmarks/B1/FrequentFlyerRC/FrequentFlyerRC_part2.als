...
pred transition__S01__a__S01__mediante_met_addMiles{
...
pred transition__S01__a__S02__mediante_met_addMiles{
	(some x,y:EstadoConcreto, v10:Address, v20:Miles |
		partitionS01[x] and partitionS02[y] and
		v10 != Address0x0 and met_addMiles[x, y, v10, v20])
}

run transition__S01__a__S01__mediante_met_addMiles for 10 EstadoConcreto, 3 Miles
run transition__S01__a__S02__mediante_met_addMiles for 10 EstadoConcreto, 3 Miles
