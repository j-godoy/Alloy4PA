...
pred transition__S03__a__S01__mediante_met_beneficiaryWithdraw{
	(some x,y:EstadoConcreto, v10:Address |
		partitionS03[x] and partitionS01[y] and
		v10 != Address0x0 and met_beneficiaryWithdraw[x, y, v10])
}

pred transition__S03__a__S02__mediante_met_beneficiaryWithdraw{
	(some x,y:EstadoConcreto, v10:Address |
		partitionS03[x] and partitionS02[y] and
		v10 != Address0x0 and met_beneficiaryWithdraw[x, y, v10])
}

pred transition__S03__a__S03__mediante_met_beneficiaryWithdraw{
	(some x,y:EstadoConcreto, v10:Address |
		partitionS03[x] and partitionS03[y] and
		v10 != Address0x0 and met_beneficiaryWithdraw[x, y, v10])
}

run transition__S03__a__S01__mediante_met_beneficiaryWithdraw for 10 EstadoConcreto, 5 Deposit, 10 SumatoriaSeq
run transition__S03__a__S02__mediante_met_beneficiaryWithdraw for 10 EstadoConcreto, 5 Deposit, 10 SumatoriaSeq
run transition__S03__a__S03__mediante_met_beneficiaryWithdraw for 10 EstadoConcreto, 5 Deposit, 10 SumatoriaSeq
...
pred transition__S03__a__S01__mediante_met_transferPrimary{
	(some x,y:EstadoConcreto, v10:Address, v11:Address |
		partitionS03[x] and partitionS01[y] and
		v10 != Address0x0 and met_transferPrimary[x, y, v10, v11])
}

pred transition__S03__a__S02__mediante_met_transferPrimary{
	(some x,y:EstadoConcreto, v10:Address, v11:Address |
		partitionS03[x] and partitionS02[y] and
		v10 != Address0x0 and met_transferPrimary[x, y, v10, v11])
}

pred transition__S03__a__S03__mediante_met_transferPrimary{
	(some x,y:EstadoConcreto, v10:Address, v11:Address |
		partitionS03[x] and partitionS03[y] and
		v10 != Address0x0 and met_transferPrimary[x, y, v10, v11])
}

run transition__S03__a__S01__mediante_met_transferPrimary for 10 EstadoConcreto, 5 Deposit, 10 SumatoriaSeq
run transition__S03__a__S02__mediante_met_transferPrimary for 10 EstadoConcreto, 5 Deposit, 10 SumatoriaSeq
run transition__S03__a__S03__mediante_met_transferPrimary for 10 EstadoConcreto, 5 Deposit, 10 SumatoriaSeq
