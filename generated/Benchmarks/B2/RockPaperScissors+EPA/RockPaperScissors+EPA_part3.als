...
pred transition__S07__a__S04__mediante_met_choicePlayer1{
...
pred transition__S07__a__S05__mediante_met_choicePlayer1{
	(some x,y:EstadoConcreto, v10:Address, v20:Int, v21:Int |
		partitionS07[x] and partitionS05[y] and
		v10 != Address0x0 and met_choicePlayer1[x, y, v10, v20, v21])
}

pred transition__S07__a__S06__mediante_met_choicePlayer1{
	(some x,y:EstadoConcreto, v10:Address, v20:Int, v21:Int |
		partitionS07[x] and partitionS06[y] and
		v10 != Address0x0 and met_choicePlayer1[x, y, v10, v20, v21])
}

pred transition__S07__a__S07__mediante_met_choicePlayer1{
	(some x,y:EstadoConcreto, v10:Address, v20:Int, v21:Int |
		partitionS07[x] and partitionS07[y] and
		v10 != Address0x0 and met_choicePlayer1[x, y, v10, v20, v21])
}

run transition__S07__a__S04__mediante_met_choicePlayer1 for 10 EstadoConcreto
run transition__S07__a__S05__mediante_met_choicePlayer1 for 10 EstadoConcreto
run transition__S07__a__S06__mediante_met_choicePlayer1 for 10 EstadoConcreto
run transition__S07__a__S07__mediante_met_choicePlayer1 for 10 EstadoConcreto
pred transition__S07__a__S04__mediante_met_choicePlayer2{
	(some x,y:EstadoConcreto, v10:Address, v20:Int, v21:Int |
		partitionS07[x] and partitionS04[y] and
		v10 != Address0x0 and met_choicePlayer2[x, y, v10, v20, v21])
}

pred transition__S07__a__S05__mediante_met_choicePlayer2{
	(some x,y:EstadoConcreto, v10:Address, v20:Int, v21:Int |
		partitionS07[x] and partitionS05[y] and
		v10 != Address0x0 and met_choicePlayer2[x, y, v10, v20, v21])
}

pred transition__S07__a__S06__mediante_met_choicePlayer2{
	(some x,y:EstadoConcreto, v10:Address, v20:Int, v21:Int |
		partitionS07[x] and partitionS06[y] and
		v10 != Address0x0 and met_choicePlayer2[x, y, v10, v20, v21])
}

pred transition__S07__a__S07__mediante_met_choicePlayer2{
	(some x,y:EstadoConcreto, v10:Address, v20:Int, v21:Int |
		partitionS07[x] and partitionS07[y] and
		v10 != Address0x0 and met_choicePlayer2[x, y, v10, v20, v21])
}

run transition__S07__a__S04__mediante_met_choicePlayer2 for 10 EstadoConcreto
run transition__S07__a__S05__mediante_met_choicePlayer2 for 10 EstadoConcreto
run transition__S07__a__S06__mediante_met_choicePlayer2 for 10 EstadoConcreto
run transition__S07__a__S07__mediante_met_choicePlayer2 for 10 EstadoConcreto
pred transition__S07__a__S04__mediante_met_determineWinner{
	(some x,y:EstadoConcreto, v10:Address |
		partitionS07[x] and partitionS04[y] and
		v10 != Address0x0 and met_determineWinner[x, y, v10])
}

pred transition__S07__a__S05__mediante_met_determineWinner{
	(some x,y:EstadoConcreto, v10:Address |
		partitionS07[x] and partitionS05[y] and
		v10 != Address0x0 and met_determineWinner[x, y, v10])
}

pred transition__S07__a__S06__mediante_met_determineWinner{
	(some x,y:EstadoConcreto, v10:Address |
		partitionS07[x] and partitionS06[y] and
		v10 != Address0x0 and met_determineWinner[x, y, v10])
}

pred transition__S07__a__S07__mediante_met_determineWinner{
	(some x,y:EstadoConcreto, v10:Address |
		partitionS07[x] and partitionS07[y] and
		v10 != Address0x0 and met_determineWinner[x, y, v10])
}

run transition__S07__a__S04__mediante_met_determineWinner for 10 EstadoConcreto
run transition__S07__a__S05__mediante_met_determineWinner for 10 EstadoConcreto
run transition__S07__a__S06__mediante_met_determineWinner for 10 EstadoConcreto
run transition__S07__a__S07__mediante_met_determineWinner for 10 EstadoConcreto
