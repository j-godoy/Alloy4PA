...
pred transition__S00__a__S238__mediante_met_constructor {
	(some x,y:EstadoConcreto, v10:Address, v11:Address, v12:Address |
		partitionS00[x] and partitionS238[y] and
		v10 != Address0x0 and met_constructor [x, y, v10, v11, v12])
}

pred transition__S00__a__S499__mediante_met_constructor {
	(some x,y:EstadoConcreto, v10:Address, v11:Address, v12:Address |
		partitionS00[x] and partitionS499[y] and
		v10 != Address0x0 and met_constructor [x, y, v10, v11, v12])
}

pred transition__S00__a__S905__mediante_met_constructor {
	(some x,y:EstadoConcreto, v10:Address, v11:Address, v12:Address |
		partitionS00[x] and partitionS905[y] and
		v10 != Address0x0 and met_constructor [x, y, v10, v11, v12])
}

pred transition__S00__a__S997__mediante_met_constructor {
	(some x,y:EstadoConcreto, v10:Address, v11:Address, v12:Address |
		partitionS00[x] and partitionS997[y] and
		v10 != Address0x0 and met_constructor [x, y, v10, v11, v12])
}

pred transition__S00__a__S1014__mediante_met_constructor {
	(some x,y:EstadoConcreto, v10:Address, v11:Address, v12:Address |
		partitionS00[x] and partitionS1014[y] and
		v10 != Address0x0 and met_constructor [x, y, v10, v11, v12])
}

run transition__S00__a__S238__mediante_met_constructor  for 10 EstadoConcreto, 5 Deposit, 10 SumatoriaSeq
run transition__S00__a__S499__mediante_met_constructor  for 10 EstadoConcreto, 5 Deposit, 10 SumatoriaSeq
run transition__S00__a__S905__mediante_met_constructor  for 10 EstadoConcreto, 5 Deposit, 10 SumatoriaSeq
run transition__S00__a__S997__mediante_met_constructor  for 10 EstadoConcreto, 5 Deposit, 10 SumatoriaSeq
run transition__S00__a__S1014__mediante_met_constructor  for 10 EstadoConcreto, 5 Deposit, 10 SumatoriaSeq
