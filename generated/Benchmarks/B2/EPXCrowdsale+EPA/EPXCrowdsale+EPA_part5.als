...
pred transition__S49__a__S23__mediante_met_setupCrowdsale{
	(some x,y:EstadoConcreto, v10:Address, v20:Int, v21:Int, v22:Int |
		partitionS49[x] and partitionS23[y] and
		v10 != Address0x0 and met_setupCrowdsale[x, y, v10, v20, v21, v22])
}

pred transition__S49__a__S25__mediante_met_setupCrowdsale{
	(some x,y:EstadoConcreto, v10:Address, v20:Int, v21:Int, v22:Int |
		partitionS49[x] and partitionS25[y] and
		v10 != Address0x0 and met_setupCrowdsale[x, y, v10, v20, v21, v22])
}

pred transition__S49__a__S44__mediante_met_setupCrowdsale{
	(some x,y:EstadoConcreto, v10:Address, v20:Int, v21:Int, v22:Int |
		partitionS49[x] and partitionS44[y] and
		v10 != Address0x0 and met_setupCrowdsale[x, y, v10, v20, v21, v22])
}

pred transition__S49__a__S49__mediante_met_setupCrowdsale{
	(some x,y:EstadoConcreto, v10:Address, v20:Int, v21:Int, v22:Int |
		partitionS49[x] and partitionS49[y] and
		v10 != Address0x0 and met_setupCrowdsale[x, y, v10, v20, v21, v22])
}

pred transition__S49__a__S58__mediante_met_setupCrowdsale{
	(some x,y:EstadoConcreto, v10:Address, v20:Int, v21:Int, v22:Int |
		partitionS49[x] and partitionS58[y] and
		v10 != Address0x0 and met_setupCrowdsale[x, y, v10, v20, v21, v22])
}

run transition__S49__a__S23__mediante_met_setupCrowdsale for 10 EstadoConcreto, 3 Deposit
run transition__S49__a__S25__mediante_met_setupCrowdsale for 10 EstadoConcreto, 3 Deposit
run transition__S49__a__S44__mediante_met_setupCrowdsale for 10 EstadoConcreto, 3 Deposit
run transition__S49__a__S49__mediante_met_setupCrowdsale for 10 EstadoConcreto, 3 Deposit
run transition__S49__a__S58__mediante_met_setupCrowdsale for 10 EstadoConcreto, 3 Deposit
pred transition__S49__a__S23__mediante_met_buy{
	(some x,y:EstadoConcreto, v10:Address, v20:Int |
		partitionS49[x] and partitionS23[y] and
		v10 != Address0x0 and met_buy[x, y, v10, v20])
}

pred transition__S49__a__S25__mediante_met_buy{
	(some x,y:EstadoConcreto, v10:Address, v20:Int |
		partitionS49[x] and partitionS25[y] and
		v10 != Address0x0 and met_buy[x, y, v10, v20])
}

pred transition__S49__a__S44__mediante_met_buy{
	(some x,y:EstadoConcreto, v10:Address, v20:Int |
		partitionS49[x] and partitionS44[y] and
		v10 != Address0x0 and met_buy[x, y, v10, v20])
}

pred transition__S49__a__S49__mediante_met_buy{
	(some x,y:EstadoConcreto, v10:Address, v20:Int |
		partitionS49[x] and partitionS49[y] and
		v10 != Address0x0 and met_buy[x, y, v10, v20])
}

pred transition__S49__a__S58__mediante_met_buy{
	(some x,y:EstadoConcreto, v10:Address, v20:Int |
		partitionS49[x] and partitionS58[y] and
		v10 != Address0x0 and met_buy[x, y, v10, v20])
}

run transition__S49__a__S23__mediante_met_buy for 10 EstadoConcreto, 3 Deposit
run transition__S49__a__S25__mediante_met_buy for 10 EstadoConcreto, 3 Deposit
run transition__S49__a__S44__mediante_met_buy for 10 EstadoConcreto, 3 Deposit
run transition__S49__a__S49__mediante_met_buy for 10 EstadoConcreto, 3 Deposit
run transition__S49__a__S58__mediante_met_buy for 10 EstadoConcreto, 3 Deposit
pred transition__S49__a__S23__mediante_met_checkGoalReached{
	(some x,y:EstadoConcreto, v10:Address |
		partitionS49[x] and partitionS23[y] and
		v10 != Address0x0 and met_checkGoalReached[x, y, v10])
}

pred transition__S49__a__S25__mediante_met_checkGoalReached{
	(some x,y:EstadoConcreto, v10:Address |
		partitionS49[x] and partitionS25[y] and
		v10 != Address0x0 and met_checkGoalReached[x, y, v10])
}

pred transition__S49__a__S44__mediante_met_checkGoalReached{
	(some x,y:EstadoConcreto, v10:Address |
		partitionS49[x] and partitionS44[y] and
		v10 != Address0x0 and met_checkGoalReached[x, y, v10])
}

pred transition__S49__a__S49__mediante_met_checkGoalReached{
	(some x,y:EstadoConcreto, v10:Address |
		partitionS49[x] and partitionS49[y] and
		v10 != Address0x0 and met_checkGoalReached[x, y, v10])
}

pred transition__S49__a__S58__mediante_met_checkGoalReached{
	(some x,y:EstadoConcreto, v10:Address |
		partitionS49[x] and partitionS58[y] and
		v10 != Address0x0 and met_checkGoalReached[x, y, v10])
}

run transition__S49__a__S23__mediante_met_checkGoalReached for 10 EstadoConcreto, 3 Deposit
run transition__S49__a__S25__mediante_met_checkGoalReached for 10 EstadoConcreto, 3 Deposit
run transition__S49__a__S44__mediante_met_checkGoalReached for 10 EstadoConcreto, 3 Deposit
run transition__S49__a__S49__mediante_met_checkGoalReached for 10 EstadoConcreto, 3 Deposit
run transition__S49__a__S58__mediante_met_checkGoalReached for 10 EstadoConcreto, 3 Deposit
pred transition__S49__a__S23__mediante_met_refund{
	(some x,y:EstadoConcreto, v10:Address |
		partitionS49[x] and partitionS23[y] and
		v10 != Address0x0 and met_refund[x, y, v10])
}

pred transition__S49__a__S25__mediante_met_refund{
	(some x,y:EstadoConcreto, v10:Address |
		partitionS49[x] and partitionS25[y] and
		v10 != Address0x0 and met_refund[x, y, v10])
}

pred transition__S49__a__S44__mediante_met_refund{
	(some x,y:EstadoConcreto, v10:Address |
		partitionS49[x] and partitionS44[y] and
		v10 != Address0x0 and met_refund[x, y, v10])
}

pred transition__S49__a__S49__mediante_met_refund{
	(some x,y:EstadoConcreto, v10:Address |
		partitionS49[x] and partitionS49[y] and
		v10 != Address0x0 and met_refund[x, y, v10])
}

pred transition__S49__a__S58__mediante_met_refund{
	(some x,y:EstadoConcreto, v10:Address |
		partitionS49[x] and partitionS58[y] and
		v10 != Address0x0 and met_refund[x, y, v10])
}

run transition__S49__a__S23__mediante_met_refund for 10 EstadoConcreto, 3 Deposit
run transition__S49__a__S25__mediante_met_refund for 10 EstadoConcreto, 3 Deposit
run transition__S49__a__S44__mediante_met_refund for 10 EstadoConcreto, 3 Deposit
run transition__S49__a__S49__mediante_met_refund for 10 EstadoConcreto, 3 Deposit
run transition__S49__a__S58__mediante_met_refund for 10 EstadoConcreto, 3 Deposit
pred transition__S49__a__S23__mediante_met_t{
	(some x,y:EstadoConcreto, v10:Address |
		partitionS49[x] and partitionS23[y] and
		v10 != Address0x0 and met_t[x, y, v10])
}

pred transition__S49__a__S25__mediante_met_t{
	(some x,y:EstadoConcreto, v10:Address |
		partitionS49[x] and partitionS25[y] and
		v10 != Address0x0 and met_t[x, y, v10])
}

pred transition__S49__a__S44__mediante_met_t{
	(some x,y:EstadoConcreto, v10:Address |
		partitionS49[x] and partitionS44[y] and
		v10 != Address0x0 and met_t[x, y, v10])
}

pred transition__S49__a__S49__mediante_met_t{
	(some x,y:EstadoConcreto, v10:Address |
		partitionS49[x] and partitionS49[y] and
		v10 != Address0x0 and met_t[x, y, v10])
}

pred transition__S49__a__S58__mediante_met_t{
	(some x,y:EstadoConcreto, v10:Address |
		partitionS49[x] and partitionS58[y] and
		v10 != Address0x0 and met_t[x, y, v10])
}

run transition__S49__a__S23__mediante_met_t for 10 EstadoConcreto, 3 Deposit
run transition__S49__a__S25__mediante_met_t for 10 EstadoConcreto, 3 Deposit
run transition__S49__a__S44__mediante_met_t for 10 EstadoConcreto, 3 Deposit
run transition__S49__a__S49__mediante_met_t for 10 EstadoConcreto, 3 Deposit
run transition__S49__a__S58__mediante_met_t for 10 EstadoConcreto, 3 Deposit
