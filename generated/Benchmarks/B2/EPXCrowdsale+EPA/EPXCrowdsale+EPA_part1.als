...
pred transition__S00__a__S49__mediante_met_constructor {
	(some x,y:EstadoConcreto, v10:Address |
		partitionS00[x] and partitionS49[y] and
		v10 != Address0x0 and met_constructor [x, y, v10])
}

pred transition__S00__a__S58__mediante_met_constructor {
	(some x,y:EstadoConcreto, v10:Address |
		partitionS00[x] and partitionS58[y] and
		v10 != Address0x0 and met_constructor [x, y, v10])
}

run transition__S00__a__S23__mediante_met_constructor  for 10 EstadoConcreto, 3 Deposit
run transition__S00__a__S25__mediante_met_constructor  for 10 EstadoConcreto, 3 Deposit
run transition__S00__a__S44__mediante_met_constructor  for 10 EstadoConcreto, 3 Deposit
run transition__S00__a__S49__mediante_met_constructor  for 10 EstadoConcreto, 3 Deposit
run transition__S00__a__S58__mediante_met_constructor  for 10 EstadoConcreto, 3 Deposit
