...
pred transition__S12__a__S01__mediante_met_bid{
	(some x,y:EstadoConcreto, v10:Address, v20:Int |
		partitionS12[x] and partitionS01[y] and
...
pred transition__S12__a__S03__mediante_met_bid{
	(some x,y:EstadoConcreto, v10:Address, v20:Int |
		partitionS12[x] and partitionS03[y] and
		v10 != Address0x0 and met_bid[x, y, v10, v20])
}
...
run transition__S12__a__S01__mediante_met_bid for 10 EstadoConcreto
run transition__S12__a__S02__mediante_met_bid for 10 EstadoConcreto
run transition__S12__a__S03__mediante_met_bid for 10 EstadoConcreto
...
pred transition__S12__a__S01__mediante_met_withdraw{
...
pred transition__S12__a__S03__mediante_met_withdraw{
	(some x,y:EstadoConcreto, v10:Address |
		partitionS12[x] and partitionS03[y] and
		v10 != Address0x0 and met_withdraw[x, y, v10])
}
...
run transition__S12__a__S01__mediante_met_withdraw for 10 EstadoConcreto
run transition__S12__a__S02__mediante_met_withdraw for 10 EstadoConcreto
run transition__S12__a__S03__mediante_met_withdraw for 10 EstadoConcreto
...
pred transition__S12__a__S01__mediante_met_auctionEnd{
	(some x,y:EstadoConcreto, v10:Address |
		partitionS12[x] and partitionS01[y] and
...
pred transition__S12__a__S03__mediante_met_auctionEnd{
	(some x,y:EstadoConcreto, v10:Address |
		partitionS12[x] and partitionS03[y] and
		v10 != Address0x0 and met_auctionEnd[x, y, v10])
}
...
run transition__S12__a__S01__mediante_met_auctionEnd for 10 EstadoConcreto
run transition__S12__a__S02__mediante_met_auctionEnd for 10 EstadoConcreto
run transition__S12__a__S03__mediante_met_auctionEnd for 10 EstadoConcreto
...
pred transition__S12__a__S01__mediante_met_t{
	(some x,y:EstadoConcreto, v10:Address |
		partitionS12[x] and partitionS01[y] and
...
pred transition__S12__a__S03__mediante_met_t{
	(some x,y:EstadoConcreto, v10:Address |
		partitionS12[x] and partitionS03[y] and
		v10 != Address0x0 and met_t[x, y, v10])
}
...
run transition__S12__a__S01__mediante_met_t for 10 EstadoConcreto
run transition__S12__a__S02__mediante_met_t for 10 EstadoConcreto
run transition__S12__a__S03__mediante_met_t for 10 EstadoConcreto
