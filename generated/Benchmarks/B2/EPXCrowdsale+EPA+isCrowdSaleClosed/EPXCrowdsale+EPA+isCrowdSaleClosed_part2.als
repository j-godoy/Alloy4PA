...
pred transition__S23__a__S89__mediante_met_setupCrowdsale{
	(some x,y:EstadoConcreto, v10:Address, v20:Int, v21:Int, v22:Int |
		partitionS23[x] and partitionS89[y] and
		v10 != Address0x0 and met_setupCrowdsale[x, y, v10, v20, v21, v22])
}

pred transition__S23__a__S108__mediante_met_setupCrowdsale{
	(some x,y:EstadoConcreto, v10:Address, v20:Int, v21:Int, v22:Int |
		partitionS23[x] and partitionS108[y] and
		v10 != Address0x0 and met_setupCrowdsale[x, y, v10, v20, v21, v22])
}

pred transition__S23__a__S113__mediante_met_setupCrowdsale{
	(some x,y:EstadoConcreto, v10:Address, v20:Int, v21:Int, v22:Int |
		partitionS23[x] and partitionS113[y] and
		v10 != Address0x0 and met_setupCrowdsale[x, y, v10, v20, v21, v22])
}

pred transition__S23__a__S122__mediante_met_setupCrowdsale{
	(some x,y:EstadoConcreto, v10:Address, v20:Int, v21:Int, v22:Int |
		partitionS23[x] and partitionS122[y] and
		v10 != Address0x0 and met_setupCrowdsale[x, y, v10, v20, v21, v22])
}
...
run transition__S23__a__S89__mediante_met_setupCrowdsale for 10 EstadoConcreto, 3 Deposit
run transition__S23__a__S108__mediante_met_setupCrowdsale for 10 EstadoConcreto, 3 Deposit
run transition__S23__a__S113__mediante_met_setupCrowdsale for 10 EstadoConcreto, 3 Deposit
run transition__S23__a__S122__mediante_met_setupCrowdsale for 10 EstadoConcreto, 3 Deposit
...
pred transition__S23__a__S89__mediante_met_buy{
	(some x,y:EstadoConcreto, v10:Address, v20:Int |
		partitionS23[x] and partitionS89[y] and
		v10 != Address0x0 and met_buy[x, y, v10, v20])
}

pred transition__S23__a__S108__mediante_met_buy{
	(some x,y:EstadoConcreto, v10:Address, v20:Int |
		partitionS23[x] and partitionS108[y] and
		v10 != Address0x0 and met_buy[x, y, v10, v20])
}

pred transition__S23__a__S113__mediante_met_buy{
	(some x,y:EstadoConcreto, v10:Address, v20:Int |
		partitionS23[x] and partitionS113[y] and
		v10 != Address0x0 and met_buy[x, y, v10, v20])
}

pred transition__S23__a__S122__mediante_met_buy{
	(some x,y:EstadoConcreto, v10:Address, v20:Int |
		partitionS23[x] and partitionS122[y] and
		v10 != Address0x0 and met_buy[x, y, v10, v20])
}
...
run transition__S23__a__S89__mediante_met_buy for 10 EstadoConcreto, 3 Deposit
run transition__S23__a__S108__mediante_met_buy for 10 EstadoConcreto, 3 Deposit
run transition__S23__a__S113__mediante_met_buy for 10 EstadoConcreto, 3 Deposit
run transition__S23__a__S122__mediante_met_buy for 10 EstadoConcreto, 3 Deposit
...
pred transition__S23__a__S89__mediante_met_checkGoalReached{
	(some x,y:EstadoConcreto, v10:Address |
		partitionS23[x] and partitionS89[y] and
		v10 != Address0x0 and met_checkGoalReached[x, y, v10])
}

pred transition__S23__a__S108__mediante_met_checkGoalReached{
	(some x,y:EstadoConcreto, v10:Address |
		partitionS23[x] and partitionS108[y] and
		v10 != Address0x0 and met_checkGoalReached[x, y, v10])
}

pred transition__S23__a__S113__mediante_met_checkGoalReached{
	(some x,y:EstadoConcreto, v10:Address |
		partitionS23[x] and partitionS113[y] and
		v10 != Address0x0 and met_checkGoalReached[x, y, v10])
}

pred transition__S23__a__S122__mediante_met_checkGoalReached{
	(some x,y:EstadoConcreto, v10:Address |
		partitionS23[x] and partitionS122[y] and
		v10 != Address0x0 and met_checkGoalReached[x, y, v10])
}
...
run transition__S23__a__S89__mediante_met_checkGoalReached for 10 EstadoConcreto, 3 Deposit
run transition__S23__a__S108__mediante_met_checkGoalReached for 10 EstadoConcreto, 3 Deposit
run transition__S23__a__S113__mediante_met_checkGoalReached for 10 EstadoConcreto, 3 Deposit
run transition__S23__a__S122__mediante_met_checkGoalReached for 10 EstadoConcreto, 3 Deposit
...
pred transition__S23__a__S89__mediante_met_refund{
	(some x,y:EstadoConcreto, v10:Address |
		partitionS23[x] and partitionS89[y] and
		v10 != Address0x0 and met_refund[x, y, v10])
}

pred transition__S23__a__S108__mediante_met_refund{
	(some x,y:EstadoConcreto, v10:Address |
		partitionS23[x] and partitionS108[y] and
		v10 != Address0x0 and met_refund[x, y, v10])
}

pred transition__S23__a__S113__mediante_met_refund{
	(some x,y:EstadoConcreto, v10:Address |
		partitionS23[x] and partitionS113[y] and
		v10 != Address0x0 and met_refund[x, y, v10])
}

pred transition__S23__a__S122__mediante_met_refund{
	(some x,y:EstadoConcreto, v10:Address |
		partitionS23[x] and partitionS122[y] and
		v10 != Address0x0 and met_refund[x, y, v10])
}
...
run transition__S23__a__S89__mediante_met_refund for 10 EstadoConcreto, 3 Deposit
run transition__S23__a__S108__mediante_met_refund for 10 EstadoConcreto, 3 Deposit
run transition__S23__a__S113__mediante_met_refund for 10 EstadoConcreto, 3 Deposit
run transition__S23__a__S122__mediante_met_refund for 10 EstadoConcreto, 3 Deposit
...
pred transition__S23__a__S89__mediante_met_t{
	(some x,y:EstadoConcreto, v10:Address |
		partitionS23[x] and partitionS89[y] and
		v10 != Address0x0 and met_t[x, y, v10])
}

pred transition__S23__a__S108__mediante_met_t{
	(some x,y:EstadoConcreto, v10:Address |
		partitionS23[x] and partitionS108[y] and
		v10 != Address0x0 and met_t[x, y, v10])
}

pred transition__S23__a__S113__mediante_met_t{
	(some x,y:EstadoConcreto, v10:Address |
		partitionS23[x] and partitionS113[y] and
		v10 != Address0x0 and met_t[x, y, v10])
}

pred transition__S23__a__S122__mediante_met_t{
	(some x,y:EstadoConcreto, v10:Address |
		partitionS23[x] and partitionS122[y] and
		v10 != Address0x0 and met_t[x, y, v10])
}
...
run transition__S23__a__S89__mediante_met_t for 10 EstadoConcreto, 3 Deposit
run transition__S23__a__S108__mediante_met_t for 10 EstadoConcreto, 3 Deposit
run transition__S23__a__S113__mediante_met_t for 10 EstadoConcreto, 3 Deposit
run transition__S23__a__S122__mediante_met_t for 10 EstadoConcreto, 3 Deposit
