...
pred transition__S00__a__S23__mediante_met_constructor {
	(some x,y:EstadoConcreto, v10:Address |
		partitionS00[x] and partitionS23[y] and
		v10 != Address0x0 and met_constructor [x, y, v10])
}

pred transition__S00__a__S44__mediante_met_constructor {
	(some x,y:EstadoConcreto, v10:Address |
		partitionS00[x] and partitionS44[y] and
		v10 != Address0x0 and met_constructor [x, y, v10])
}

pred transition__S00__a__S89__mediante_met_constructor {
	(some x,y:EstadoConcreto, v10:Address |
		partitionS00[x] and partitionS89[y] and
		v10 != Address0x0 and met_constructor [x, y, v10])
}

pred transition__S00__a__S108__mediante_met_constructor {
	(some x,y:EstadoConcreto, v10:Address |
		partitionS00[x] and partitionS108[y] and
		v10 != Address0x0 and met_constructor [x, y, v10])
}

pred transition__S00__a__S113__mediante_met_constructor {
	(some x,y:EstadoConcreto, v10:Address |
		partitionS00[x] and partitionS113[y] and
		v10 != Address0x0 and met_constructor [x, y, v10])
}

pred transition__S00__a__S122__mediante_met_constructor {
	(some x,y:EstadoConcreto, v10:Address |
		partitionS00[x] and partitionS122[y] and
		v10 != Address0x0 and met_constructor [x, y, v10])
}

run transition__S00__a__S23__mediante_met_constructor  for 10 EstadoConcreto, 3 Deposit
run transition__S00__a__S44__mediante_met_constructor  for 10 EstadoConcreto, 3 Deposit
run transition__S00__a__S89__mediante_met_constructor  for 10 EstadoConcreto, 3 Deposit
run transition__S00__a__S108__mediante_met_constructor  for 10 EstadoConcreto, 3 Deposit
run transition__S00__a__S113__mediante_met_constructor  for 10 EstadoConcreto, 3 Deposit
run transition__S00__a__S122__mediante_met_constructor  for 10 EstadoConcreto, 3 Deposit
