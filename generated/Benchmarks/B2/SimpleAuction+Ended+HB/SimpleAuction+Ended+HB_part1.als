...
run transition__S01__a__S05__mediante_met_bid for 10 EstadoConcreto
...
run transition__S02__a__S05__mediante_met_bid for 10 EstadoConcreto
...
run transition__S01__a__S05__mediante_met_withdraw for 10 EstadoConcreto
...
run transition__S02__a__S05__mediante_met_withdraw for 10 EstadoConcreto
...
pred transition__S01__a__S05__mediante_met_auctionEnd{
	(some x,y:EstadoConcreto, v10:Address |
		partitionS01[x] and partitionS05[y] and
		v10 != Address0x0 and met_auctionEnd[x, y, v10])
}
...
pred transition__S02__a__S05__mediante_met_auctionEnd{
	(some x,y:EstadoConcreto, v10:Address |
		partitionS02[x] and partitionS05[y] and
		v10 != Address0x0 and met_auctionEnd[x, y, v10])
}
...
run transition__S01__a__S05__mediante_met_auctionEnd for 10 EstadoConcreto
...
run transition__S02__a__S05__mediante_met_auctionEnd for 10 EstadoConcreto
...
run transition__S01__a__S05__mediante_met_t for 10 EstadoConcreto
...
run transition__S02__a__S05__mediante_met_t for 10 EstadoConcreto
