...
pred transition__S06__a__S05__mediante_met_bid{
	(some x,y:EstadoConcreto, v10:Address, v20:Int |
...
run transition__S06__a__S05__mediante_met_bid for 10 EstadoConcreto
...
pred transition__S06__a__S05__mediante_met_withdraw{
	(some x,y:EstadoConcreto, v10:Address |
		partitionS06[x] and partitionS05[y] and
		v10 != Address0x0 and met_withdraw[x, y, v10])
}
...
run transition__S06__a__S05__mediante_met_withdraw for 10 EstadoConcreto
...
pred transition__S06__a__S05__mediante_met_auctionEnd{
	(some x,y:EstadoConcreto, v10:Address |
		partitionS06[x] and partitionS05[y] and
		v10 != Address0x0 and met_auctionEnd[x, y, v10])
}
...
run transition__S06__a__S05__mediante_met_auctionEnd for 10 EstadoConcreto
...
run transition__S06__a__S05__mediante_met_t for 10 EstadoConcreto
