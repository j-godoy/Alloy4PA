...
pred transition__S04__a__S01__mediante_met_transferOwnership {
...
pred transition__S04__a__S02__mediante_met_transferOwnership {
	(some x,y:EstadoConcreto, v10:Address, v11:Address |
		partitionS04[x] and partitionS02[y] and
		v10 != Address0x0 and met_transferOwnership [x, y, v10, v11])
}

pred transition__S04__a__S03__mediante_met_transferOwnership {
	(some x,y:EstadoConcreto, v10:Address, v11:Address |
		partitionS04[x] and partitionS03[y] and
		v10 != Address0x0 and met_transferOwnership [x, y, v10, v11])
}

pred transition__S04__a__S04__mediante_met_transferOwnership {
	(some x,y:EstadoConcreto, v10:Address, v11:Address |
		partitionS04[x] and partitionS04[y] and
		v10 != Address0x0 and met_transferOwnership [x, y, v10, v11])
}

run transition__S04__a__S01__mediante_met_transferOwnership  for 10 EstadoConcreto, 5 Deposit, 10 SumatoriaSeq
run transition__S04__a__S02__mediante_met_transferOwnership  for 10 EstadoConcreto, 5 Deposit, 10 SumatoriaSeq
run transition__S04__a__S03__mediante_met_transferOwnership  for 10 EstadoConcreto, 5 Deposit, 10 SumatoriaSeq
run transition__S04__a__S04__mediante_met_transferOwnership  for 10 EstadoConcreto, 5 Deposit, 10 SumatoriaSeq
pred transition__S04__a__S01__mediante_met_deposit {
	(some x,y:EstadoConcreto, v10:Address, v11:Address, v20:Int |
		partitionS04[x] and partitionS01[y] and
		v10 != Address0x0 and met_deposit [x, y, v10, v11, v20])
}

pred transition__S04__a__S02__mediante_met_deposit {
	(some x,y:EstadoConcreto, v10:Address, v11:Address, v20:Int |
		partitionS04[x] and partitionS02[y] and
		v10 != Address0x0 and met_deposit [x, y, v10, v11, v20])
}

pred transition__S04__a__S03__mediante_met_deposit {
	(some x,y:EstadoConcreto, v10:Address, v11:Address, v20:Int |
		partitionS04[x] and partitionS03[y] and
		v10 != Address0x0 and met_deposit [x, y, v10, v11, v20])
}

pred transition__S04__a__S04__mediante_met_deposit {
	(some x,y:EstadoConcreto, v10:Address, v11:Address, v20:Int |
		partitionS04[x] and partitionS04[y] and
		v10 != Address0x0 and met_deposit [x, y, v10, v11, v20])
}

run transition__S04__a__S01__mediante_met_deposit  for 10 EstadoConcreto, 5 Deposit, 10 SumatoriaSeq
run transition__S04__a__S02__mediante_met_deposit  for 10 EstadoConcreto, 5 Deposit, 10 SumatoriaSeq
run transition__S04__a__S03__mediante_met_deposit  for 10 EstadoConcreto, 5 Deposit, 10 SumatoriaSeq
run transition__S04__a__S04__mediante_met_deposit  for 10 EstadoConcreto, 5 Deposit, 10 SumatoriaSeq
pred transition__S04__a__S01__mediante_met_setGoalReached {
	(some x,y:EstadoConcreto, v10:Address, v20:Int |
		partitionS04[x] and partitionS01[y] and
		v10 != Address0x0 and met_setGoalReached [x, y, v10, v20])
}

pred transition__S04__a__S02__mediante_met_setGoalReached {
	(some x,y:EstadoConcreto, v10:Address, v20:Int |
		partitionS04[x] and partitionS02[y] and
		v10 != Address0x0 and met_setGoalReached [x, y, v10, v20])
}

pred transition__S04__a__S03__mediante_met_setGoalReached {
	(some x,y:EstadoConcreto, v10:Address, v20:Int |
		partitionS04[x] and partitionS03[y] and
		v10 != Address0x0 and met_setGoalReached [x, y, v10, v20])
}

pred transition__S04__a__S04__mediante_met_setGoalReached {
	(some x,y:EstadoConcreto, v10:Address, v20:Int |
		partitionS04[x] and partitionS04[y] and
		v10 != Address0x0 and met_setGoalReached [x, y, v10, v20])
}

run transition__S04__a__S01__mediante_met_setGoalReached  for 10 EstadoConcreto, 5 Deposit, 10 SumatoriaSeq
run transition__S04__a__S02__mediante_met_setGoalReached  for 10 EstadoConcreto, 5 Deposit, 10 SumatoriaSeq
run transition__S04__a__S03__mediante_met_setGoalReached  for 10 EstadoConcreto, 5 Deposit, 10 SumatoriaSeq
run transition__S04__a__S04__mediante_met_setGoalReached  for 10 EstadoConcreto, 5 Deposit, 10 SumatoriaSeq
...
run transition__S04__a__S01__mediante_met_withdraw  for 10 EstadoConcreto, 5 Deposit, 10 SumatoriaSeq
run transition__S04__a__S02__mediante_met_withdraw  for 10 EstadoConcreto, 5 Deposit, 10 SumatoriaSeq
run transition__S04__a__S03__mediante_met_withdraw  for 10 EstadoConcreto, 5 Deposit, 10 SumatoriaSeq
run transition__S04__a__S04__mediante_met_withdraw  for 10 EstadoConcreto, 5 Deposit, 10 SumatoriaSeq
pred transition__S04__a__S01__mediante_met_withdrawAll {
	(some x,y:EstadoConcreto, v10:Address |
		partitionS04[x] and partitionS01[y] and
		v10 != Address0x0 and met_withdrawAll [x, y, v10])
}

pred transition__S04__a__S02__mediante_met_withdrawAll {
	(some x,y:EstadoConcreto, v10:Address |
		partitionS04[x] and partitionS02[y] and
		v10 != Address0x0 and met_withdrawAll [x, y, v10])
}

pred transition__S04__a__S03__mediante_met_withdrawAll {
	(some x,y:EstadoConcreto, v10:Address |
		partitionS04[x] and partitionS03[y] and
		v10 != Address0x0 and met_withdrawAll [x, y, v10])
}

pred transition__S04__a__S04__mediante_met_withdrawAll {
	(some x,y:EstadoConcreto, v10:Address |
		partitionS04[x] and partitionS04[y] and
		v10 != Address0x0 and met_withdrawAll [x, y, v10])
}

run transition__S04__a__S01__mediante_met_withdrawAll  for 10 EstadoConcreto, 5 Deposit, 10 SumatoriaSeq
run transition__S04__a__S02__mediante_met_withdrawAll  for 10 EstadoConcreto, 5 Deposit, 10 SumatoriaSeq
run transition__S04__a__S03__mediante_met_withdrawAll  for 10 EstadoConcreto, 5 Deposit, 10 SumatoriaSeq
run transition__S04__a__S04__mediante_met_withdrawAll  for 10 EstadoConcreto, 5 Deposit, 10 SumatoriaSeq
pred transition__S04__a__S01__mediante_met_close {
	(some x,y:EstadoConcreto, v10:Address |
		partitionS04[x] and partitionS01[y] and
		v10 != Address0x0 and met_close [x, y, v10])
}

pred transition__S04__a__S02__mediante_met_close {
	(some x,y:EstadoConcreto, v10:Address |
		partitionS04[x] and partitionS02[y] and
		v10 != Address0x0 and met_close [x, y, v10])
}

pred transition__S04__a__S03__mediante_met_close {
	(some x,y:EstadoConcreto, v10:Address |
		partitionS04[x] and partitionS03[y] and
		v10 != Address0x0 and met_close [x, y, v10])
}

pred transition__S04__a__S04__mediante_met_close {
	(some x,y:EstadoConcreto, v10:Address |
		partitionS04[x] and partitionS04[y] and
		v10 != Address0x0 and met_close [x, y, v10])
}

run transition__S04__a__S01__mediante_met_close  for 10 EstadoConcreto, 5 Deposit, 10 SumatoriaSeq
run transition__S04__a__S02__mediante_met_close  for 10 EstadoConcreto, 5 Deposit, 10 SumatoriaSeq
run transition__S04__a__S03__mediante_met_close  for 10 EstadoConcreto, 5 Deposit, 10 SumatoriaSeq
run transition__S04__a__S04__mediante_met_close  for 10 EstadoConcreto, 5 Deposit, 10 SumatoriaSeq
pred transition__S04__a__S01__mediante_met_enableRefunds {
	(some x,y:EstadoConcreto, v10:Address |
		partitionS04[x] and partitionS01[y] and
		v10 != Address0x0 and met_enableRefunds [x, y, v10])
}

pred transition__S04__a__S02__mediante_met_enableRefunds {
	(some x,y:EstadoConcreto, v10:Address |
		partitionS04[x] and partitionS02[y] and
		v10 != Address0x0 and met_enableRefunds [x, y, v10])
}

pred transition__S04__a__S03__mediante_met_enableRefunds {
	(some x,y:EstadoConcreto, v10:Address |
		partitionS04[x] and partitionS03[y] and
		v10 != Address0x0 and met_enableRefunds [x, y, v10])
}

pred transition__S04__a__S04__mediante_met_enableRefunds {
	(some x,y:EstadoConcreto, v10:Address |
		partitionS04[x] and partitionS04[y] and
		v10 != Address0x0 and met_enableRefunds [x, y, v10])
}

run transition__S04__a__S01__mediante_met_enableRefunds  for 10 EstadoConcreto, 5 Deposit, 10 SumatoriaSeq
run transition__S04__a__S02__mediante_met_enableRefunds  for 10 EstadoConcreto, 5 Deposit, 10 SumatoriaSeq
run transition__S04__a__S03__mediante_met_enableRefunds  for 10 EstadoConcreto, 5 Deposit, 10 SumatoriaSeq
run transition__S04__a__S04__mediante_met_enableRefunds  for 10 EstadoConcreto, 5 Deposit, 10 SumatoriaSeq
...
run transition__S04__a__S01__mediante_met_refund  for 10 EstadoConcreto, 5 Deposit, 10 SumatoriaSeq
run transition__S04__a__S02__mediante_met_refund  for 10 EstadoConcreto, 5 Deposit, 10 SumatoriaSeq
run transition__S04__a__S03__mediante_met_refund  for 10 EstadoConcreto, 5 Deposit, 10 SumatoriaSeq
run transition__S04__a__S04__mediante_met_refund  for 10 EstadoConcreto, 5 Deposit, 10 SumatoriaSeq
...
run transition__S04__a__S01__mediante_met_t for 10 EstadoConcreto, 5 Deposit, 10 SumatoriaSeq
run transition__S04__a__S02__mediante_met_t for 10 EstadoConcreto, 5 Deposit, 10 SumatoriaSeq
run transition__S04__a__S03__mediante_met_t for 10 EstadoConcreto, 5 Deposit, 10 SumatoriaSeq
run transition__S04__a__S04__mediante_met_t for 10 EstadoConcreto, 5 Deposit, 10 SumatoriaSeq
