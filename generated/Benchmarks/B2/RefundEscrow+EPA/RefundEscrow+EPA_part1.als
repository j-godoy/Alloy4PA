...
pred transition__S00__a__S24__mediante_met_constructor{
	(some x,y:EstadoConcreto, v10:Address, v11:Address |
		...
		v10 != Address0x0 and met_constructor[x, y, v10, v11])
}

pred transition__S00__a__S65__mediante_met_constructor{
	(some x,y:EstadoConcreto, v10:Address, v11:Address |
		partitionS00[x] and partitionS65[y] and
		v10 != Address0x0 and met_constructor[x, y, v10, v11])
}

pred transition__S00__a__S66__mediante_met_constructor{
	(some x,y:EstadoConcreto, v10:Address, v11:Address |
		partitionS00[x] and partitionS66[y] and
		v10 != Address0x0 and met_constructor[x, y, v10, v11])
}
...
run transition__S00__a__S24__mediante_met_constructor for 10 EstadoConcreto, 5 Deposit, 10 SumatoriaSeq
run transition__S00__a__S65__mediante_met_constructor for 10 EstadoConcreto, 5 Deposit, 10 SumatoriaSeq
run transition__S00__a__S66__mediante_met_constructor for 10 EstadoConcreto, 5 Deposit, 10 SumatoriaSeq
run transition__S00__a__S100__mediante_met_constructor for 10 EstadoConcreto, 5 Deposit, 10 SumatoriaSeq
run transition__S00__a__S121__mediante_met_constructor for 10 EstadoConcreto, 5 Deposit, 10 SumatoriaSeq
