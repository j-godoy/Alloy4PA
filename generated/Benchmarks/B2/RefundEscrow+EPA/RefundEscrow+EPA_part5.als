...
pred transition__S100__a__S24__mediante_met_deposit{
	(some x,y:EstadoConcreto, v10:Address, v11:Address, v20:Int |
		partitionS100[x] and partitionS24[y] and
		v10 != Address0x0 and met_deposit[x, y, v10, v11, v20])
}

pred transition__S100__a__S65__mediante_met_deposit{
	(some x,y:EstadoConcreto, v10:Address, v11:Address, v20:Int |
		partitionS100[x] and partitionS65[y] and
		v10 != Address0x0 and met_deposit[x, y, v10, v11, v20])
}

pred transition__S100__a__S66__mediante_met_deposit{
	(some x,y:EstadoConcreto, v10:Address, v11:Address, v20:Int |
		partitionS100[x] and partitionS66[y] and
		v10 != Address0x0 and met_deposit[x, y, v10, v11, v20])
}

pred transition__S100__a__S100__mediante_met_deposit{
	(some x,y:EstadoConcreto, v10:Address, v11:Address, v20:Int |
		partitionS100[x] and partitionS100[y] and
		v10 != Address0x0 and met_deposit[x, y, v10, v11, v20])
}

pred transition__S100__a__S121__mediante_met_deposit{
	(some x,y:EstadoConcreto, v10:Address, v11:Address, v20:Int |
		partitionS100[x] and partitionS121[y] and
		v10 != Address0x0 and met_deposit[x, y, v10, v11, v20])
}

run transition__S100__a__S24__mediante_met_deposit for 10 EstadoConcreto, 5 Deposit, 10 SumatoriaSeq
run transition__S100__a__S65__mediante_met_deposit for 10 EstadoConcreto, 5 Deposit, 10 SumatoriaSeq
run transition__S100__a__S66__mediante_met_deposit for 10 EstadoConcreto, 5 Deposit, 10 SumatoriaSeq
run transition__S100__a__S100__mediante_met_deposit for 10 EstadoConcreto, 5 Deposit, 10 SumatoriaSeq
run transition__S100__a__S121__mediante_met_deposit for 10 EstadoConcreto, 5 Deposit, 10 SumatoriaSeq
pred transition__S100__a__S24__mediante_met_close{
	(some x,y:EstadoConcreto, v10:Address, v11:Address, v20:Int |
		partitionS100[x] and partitionS24[y] and
		v10 != Address0x0 and met_close[x, y, v10, v11, v20])
}

pred transition__S100__a__S65__mediante_met_close{
	(some x,y:EstadoConcreto, v10:Address, v11:Address, v20:Int |
		partitionS100[x] and partitionS65[y] and
		v10 != Address0x0 and met_close[x, y, v10, v11, v20])
}

pred transition__S100__a__S66__mediante_met_close{
	(some x,y:EstadoConcreto, v10:Address, v11:Address, v20:Int |
		partitionS100[x] and partitionS66[y] and
		v10 != Address0x0 and met_close[x, y, v10, v11, v20])
}

pred transition__S100__a__S100__mediante_met_close{
	(some x,y:EstadoConcreto, v10:Address, v11:Address, v20:Int |
		partitionS100[x] and partitionS100[y] and
		v10 != Address0x0 and met_close[x, y, v10, v11, v20])
}

pred transition__S100__a__S121__mediante_met_close{
	(some x,y:EstadoConcreto, v10:Address, v11:Address, v20:Int |
		partitionS100[x] and partitionS121[y] and
		v10 != Address0x0 and met_close[x, y, v10, v11, v20])
}

run transition__S100__a__S24__mediante_met_close for 10 EstadoConcreto, 5 Deposit, 10 SumatoriaSeq
run transition__S100__a__S65__mediante_met_close for 10 EstadoConcreto, 5 Deposit, 10 SumatoriaSeq
run transition__S100__a__S66__mediante_met_close for 10 EstadoConcreto, 5 Deposit, 10 SumatoriaSeq
run transition__S100__a__S100__mediante_met_close for 10 EstadoConcreto, 5 Deposit, 10 SumatoriaSeq
run transition__S100__a__S121__mediante_met_close for 10 EstadoConcreto, 5 Deposit, 10 SumatoriaSeq
pred transition__S100__a__S24__mediante_met_enableRefunds{
	(some x,y:EstadoConcreto, v10:Address |
		partitionS100[x] and partitionS24[y] and
		v10 != Address0x0 and met_enableRefunds[x, y, v10])
}

pred transition__S100__a__S65__mediante_met_enableRefunds{
	(some x,y:EstadoConcreto, v10:Address |
		partitionS100[x] and partitionS65[y] and
		v10 != Address0x0 and met_enableRefunds[x, y, v10])
}

pred transition__S100__a__S66__mediante_met_enableRefunds{
	(some x,y:EstadoConcreto, v10:Address |
		partitionS100[x] and partitionS66[y] and
		v10 != Address0x0 and met_enableRefunds[x, y, v10])
}

pred transition__S100__a__S100__mediante_met_enableRefunds{
	(some x,y:EstadoConcreto, v10:Address |
		partitionS100[x] and partitionS100[y] and
		v10 != Address0x0 and met_enableRefunds[x, y, v10])
}

pred transition__S100__a__S121__mediante_met_enableRefunds{
	(some x,y:EstadoConcreto, v10:Address |
		partitionS100[x] and partitionS121[y] and
		v10 != Address0x0 and met_enableRefunds[x, y, v10])
}

run transition__S100__a__S24__mediante_met_enableRefunds for 10 EstadoConcreto, 5 Deposit, 10 SumatoriaSeq
run transition__S100__a__S65__mediante_met_enableRefunds for 10 EstadoConcreto, 5 Deposit, 10 SumatoriaSeq
run transition__S100__a__S66__mediante_met_enableRefunds for 10 EstadoConcreto, 5 Deposit, 10 SumatoriaSeq
run transition__S100__a__S100__mediante_met_enableRefunds for 10 EstadoConcreto, 5 Deposit, 10 SumatoriaSeq
run transition__S100__a__S121__mediante_met_enableRefunds for 10 EstadoConcreto, 5 Deposit, 10 SumatoriaSeq
pred transition__S100__a__S24__mediante_met_beneficiaryWithdraw{
	(some x,y:EstadoConcreto, v10:Address |
		partitionS100[x] and partitionS24[y] and
		v10 != Address0x0 and met_beneficiaryWithdraw[x, y, v10])
}

pred transition__S100__a__S65__mediante_met_beneficiaryWithdraw{
	(some x,y:EstadoConcreto, v10:Address |
		partitionS100[x] and partitionS65[y] and
		v10 != Address0x0 and met_beneficiaryWithdraw[x, y, v10])
}

pred transition__S100__a__S66__mediante_met_beneficiaryWithdraw{
	(some x,y:EstadoConcreto, v10:Address |
		partitionS100[x] and partitionS66[y] and
		v10 != Address0x0 and met_beneficiaryWithdraw[x, y, v10])
}

pred transition__S100__a__S100__mediante_met_beneficiaryWithdraw{
	(some x,y:EstadoConcreto, v10:Address |
		partitionS100[x] and partitionS100[y] and
		v10 != Address0x0 and met_beneficiaryWithdraw[x, y, v10])
}

pred transition__S100__a__S121__mediante_met_beneficiaryWithdraw{
	(some x,y:EstadoConcreto, v10:Address |
		partitionS100[x] and partitionS121[y] and
		v10 != Address0x0 and met_beneficiaryWithdraw[x, y, v10])
}

run transition__S100__a__S24__mediante_met_beneficiaryWithdraw for 10 EstadoConcreto, 5 Deposit, 10 SumatoriaSeq
run transition__S100__a__S65__mediante_met_beneficiaryWithdraw for 10 EstadoConcreto, 5 Deposit, 10 SumatoriaSeq
run transition__S100__a__S66__mediante_met_beneficiaryWithdraw for 10 EstadoConcreto, 5 Deposit, 10 SumatoriaSeq
run transition__S100__a__S100__mediante_met_beneficiaryWithdraw for 10 EstadoConcreto, 5 Deposit, 10 SumatoriaSeq
run transition__S100__a__S121__mediante_met_beneficiaryWithdraw for 10 EstadoConcreto, 5 Deposit, 10 SumatoriaSeq
pred transition__S100__a__S24__mediante_met_withdraw{
	(some x,y:EstadoConcreto, v10:Address, v11:Address |
		partitionS100[x] and partitionS24[y] and
		v10 != Address0x0 and met_withdraw[x, y, v10, v11])
}

pred transition__S100__a__S65__mediante_met_withdraw{
	(some x,y:EstadoConcreto, v10:Address, v11:Address |
		partitionS100[x] and partitionS65[y] and
		v10 != Address0x0 and met_withdraw[x, y, v10, v11])
}

pred transition__S100__a__S66__mediante_met_withdraw{
	(some x,y:EstadoConcreto, v10:Address, v11:Address |
		partitionS100[x] and partitionS66[y] and
		v10 != Address0x0 and met_withdraw[x, y, v10, v11])
}
...
run transition__S100__a__S24__mediante_met_withdraw for 10 EstadoConcreto, 5 Deposit, 10 SumatoriaSeq
run transition__S100__a__S65__mediante_met_withdraw for 10 EstadoConcreto, 5 Deposit, 10 SumatoriaSeq
run transition__S100__a__S66__mediante_met_withdraw for 10 EstadoConcreto, 5 Deposit, 10 SumatoriaSeq
run transition__S100__a__S100__mediante_met_withdraw for 10 EstadoConcreto, 5 Deposit, 10 SumatoriaSeq
run transition__S100__a__S121__mediante_met_withdraw for 10 EstadoConcreto, 5 Deposit, 10 SumatoriaSeq
pred transition__S100__a__S24__mediante_met_transferPrimary{
	(some x,y:EstadoConcreto, v10:Address, v11:Address |
		partitionS100[x] and partitionS24[y] and
		v10 != Address0x0 and met_transferPrimary[x, y, v10, v11])
}

pred transition__S100__a__S65__mediante_met_transferPrimary{
	(some x,y:EstadoConcreto, v10:Address, v11:Address |
		partitionS100[x] and partitionS65[y] and
		v10 != Address0x0 and met_transferPrimary[x, y, v10, v11])
}

pred transition__S100__a__S66__mediante_met_transferPrimary{
	(some x,y:EstadoConcreto, v10:Address, v11:Address |
		partitionS100[x] and partitionS66[y] and
		v10 != Address0x0 and met_transferPrimary[x, y, v10, v11])
}

pred transition__S100__a__S100__mediante_met_transferPrimary{
	(some x,y:EstadoConcreto, v10:Address, v11:Address |
		partitionS100[x] and partitionS100[y] and
		v10 != Address0x0 and met_transferPrimary[x, y, v10, v11])
}

pred transition__S100__a__S121__mediante_met_transferPrimary{
	(some x,y:EstadoConcreto, v10:Address, v11:Address |
		partitionS100[x] and partitionS121[y] and
		v10 != Address0x0 and met_transferPrimary[x, y, v10, v11])
}

run transition__S100__a__S24__mediante_met_transferPrimary for 10 EstadoConcreto, 5 Deposit, 10 SumatoriaSeq
run transition__S100__a__S65__mediante_met_transferPrimary for 10 EstadoConcreto, 5 Deposit, 10 SumatoriaSeq
run transition__S100__a__S66__mediante_met_transferPrimary for 10 EstadoConcreto, 5 Deposit, 10 SumatoriaSeq
run transition__S100__a__S100__mediante_met_transferPrimary for 10 EstadoConcreto, 5 Deposit, 10 SumatoriaSeq
run transition__S100__a__S121__mediante_met_transferPrimary for 10 EstadoConcreto, 5 Deposit, 10 SumatoriaSeq
pred transition__S100__a__S24__mediante_met_t{
	(some x,y:EstadoConcreto, v10:Address, v20:Int |
		partitionS100[x] and partitionS24[y] and
		v10 != Address0x0 and met_t[x, y, v10, v20])
}

pred transition__S100__a__S65__mediante_met_t{
	(some x,y:EstadoConcreto, v10:Address, v20:Int |
		partitionS100[x] and partitionS65[y] and
		v10 != Address0x0 and met_t[x, y, v10, v20])
}

pred transition__S100__a__S66__mediante_met_t{
	(some x,y:EstadoConcreto, v10:Address, v20:Int |
		partitionS100[x] and partitionS66[y] and
		v10 != Address0x0 and met_t[x, y, v10, v20])
}
...
run transition__S100__a__S24__mediante_met_t for 10 EstadoConcreto, 5 Deposit, 10 SumatoriaSeq
run transition__S100__a__S65__mediante_met_t for 10 EstadoConcreto, 5 Deposit, 10 SumatoriaSeq
run transition__S100__a__S66__mediante_met_t for 10 EstadoConcreto, 5 Deposit, 10 SumatoriaSeq
run transition__S100__a__S100__mediante_met_t for 10 EstadoConcreto, 5 Deposit, 10 SumatoriaSeq
run transition__S100__a__S121__mediante_met_t for 10 EstadoConcreto, 5 Deposit, 10 SumatoriaSeq
